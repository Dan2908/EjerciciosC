...
Realizar un programa usando WHILE.
	1.Ingresar por teclado 5 números y mostrarlos por pantalla. Usar DEFINE
	para declarar la variable que maneja el bucle.
	2.Cálculo de la suma total. Mostrar el resultado por pantalla.
...
int main() {
	...
	double total = 0;
		//Datos de entrada
	printf("Ingrese números, presione Enter por cada uno:\n"); 
	while(c < N){
		scanf("%d", &entrada);
		total += entrada;
		c++;					
